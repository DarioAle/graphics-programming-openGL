...
const char* loadShader(const char* filename, int verbose) {
...
GLuint compileShader(const char* filename, GLuint shaderType, int verbose) {
//	char const* source = "void main() { ... ";
	char const* source = loadShader(filename,verbose);
